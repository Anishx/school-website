  ...
  return (
    <section className="bg-white py-16 md:py-20" id="contact">
      <div className="mx-auto max-w-7xl px-6">
        {/* Header */}
        <div className="mb-10">
          <p className="text-xs font-bold uppercase tracking-widest text-teal-800">Get In Touch</p>
          <h2 className="mt-2 font-display text-3xl font-bold text-ink-900 md:text-4xl">
            Visit Apollo Vidhyalayam
          </h2>
        </div>
        ...
        <div className="grid overflow-hidden border border-line-200 md:grid-cols-2">
          ...
          <div className="relative min-h-[300px] md:min-h-[400px]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3794.5!2d79.59!3d17.97!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDU4JzEyLjAiTiA3OcKwMzUnMjQuMCJF!5e0!3m2!1sen!2sin!4v1700000000000"
              className="absolute inset-0 h-full w-full border-0"
              allowFullScreen
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
              title="Apollo Vidhyalayam Location"
            />
          </div>
          ...
          <div className="flex flex-col justify-between bg-canvas-50 p-6 md:p-8">
            <div>
              ...
              <p className="mt-2 text-sm text-ink-600">
                We&apos;d love to hear from you. Reach out or visit us on campus.
              </p>
            ...
            <div className="mt-8 border-t border-line-200 pt-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-sm font-semibold text-ink-900">Schedule a Campus Tour</p>
                  <p className="mt-0.5 text-sm text-ink-600">Visit us in person — open every weekday.</p>
                  <Link
                    href="/contact"
