...
import { legacyNews, legacyDownloads } from "@/cms/public/legacy-resources";
    ...
    <main className="flex-1">
      <section className="bg-teal-900 py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/80">The latest happenings, calendar, and resources from Apollo Vidhyalayam.</p>
        </div>
      </section>
